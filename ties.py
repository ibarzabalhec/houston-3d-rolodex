...
HOU = [
    ...
    E("owns", "HOU-015", "HOU-007", "", "HOU-015", "Owns First America Homes"),
    ...
    E("owns", "Daiwa House", "HOU-022", "holds 80 percent", "HOU-022",
      "Daiwa House, which builds industrially in Japan, holds 80 percent"),
    ...
    E("partner", "HOU-167", "HOU-147", "agreed to buy off-site framing producer, August 2026", "HOU-147",
      "In August 2026 it agreed to buy the off-site framing producer PulteGroup bought in 2020."),
    E("partner", "HiveASMBLD", "HOU-002", "prints Zuri Gardens homes", "HOU-002",
      "Prints its Zuri Gardens homes with HiveASMBLD"),
    E("partner", "HiveASMBLD", "HOU-016", "prints with HiveASMBLD", "HOU-016", "Prints Gulf Shore Estates with HiveASMBLD"),
    E("partner", "HiveASMBLD", "HOU-017", "prints with HiveASMBLD", "HOU-017", "Prints Avenue J with HiveASMBLD"),
...
DFW = [
    ...
    E("develops", "DFW-CH-018", "DFW-CH-011", "", "DFW-CH-011", "Huffines Communities masterplan in Celina"),
    E("develops", "DFW-CH-018", "DFW-CH-019", "", "DFW-CH-019",
      "Huffines Communities masterplan on the former Lucas family farm"),
    ...
    E("develops", "DFW-CH-002", "DFW-CH-005", "", "DFW-CH-005",
      "Republic Property Group sells lots to roster builders"),
    ...
    E("partner", "DFW-BTR-004", "DFW-BTR-007", "built its Viridian homes", "DFW-BTR-004",
      "HHS Residential built its Viridian homes in Arlington"),
