...
HOU = [
    ...
    E("partner", "HOU-167", "HOU-147", "framing plant sold in 2026", "HOU-167",
      "it sold its framing plant in 2026"),
...
DFW = [
    ...
    E("owns", "Sekisui House", "DFW-041", "", "DFW-041", "Owner Sekisui House of Japan"),
    ...
    E("owns", "Concrete Pumping Holdings", "DFW-TR-060", "", "DFW-TR-060",
      "Its parent, Concrete Pumping Holdings"),
