...
**List** the call file, and where the page opens · **Screen** the 3×3 grid · **Cover** a cover flow · **Field** twelve printers, ICON's own record, and the code route with verbatim quotes · **Market** closings, permits by county and jurisdiction, and printed homes in Texas, each figure with a table and its sources.
